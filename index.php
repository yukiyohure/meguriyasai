	  ...
	  <div class="container">
	    ...
	    <?php if(isset($_SESSION["user_id"])){ ?>
	      <ul class="nav navbar-nav navbar-right">
	        ...
	        <li class="dropdown">
	          <a href="#" class="user_icon dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="<?php echo $h($rec["pic"]); ?>" width="28" class="img-circle"><?php echo $h($rec["name"]); ?><span class="caret"></span></a>
